...
namespace WertheApp.HelpingClasses
{
    ...
    public class TemplateSkiaSharp : ContentPage
    {
        //VARIABLES
        private static SKCanvasView skiaview;
        private static TemplateSkiaSharpDraw draw;
        private static Button b_Next;

        public TemplateSkiaSharp()
        {
            Title = "Template";

            draw = new TemplateSkiaSharpDraw();
            CreateContent();
        }
        ...
        *********************************************************************/
        void CreateTopHalf(Grid grid)
        {
            ...
            skiaview = TemplateSkiaSharpDraw.ReturnCanvas();
